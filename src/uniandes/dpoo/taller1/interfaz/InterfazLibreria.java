	...
	public void cargarArchivos(File archivo_categorias, File archivo_libros)
	{
		try
		{
			...
			if (libreria.hayCategoriasNoExisten())
			{
				...
				String mensaje = "Se a�adieron las siguientes categorias que no estaban en el archivo de categorias: ";
				...
				JOptionPane.showMessageDialog(this, mensaje, "Categorias a�adidas",JOptionPane.INFORMATION_MESSAGE);
			}
		}
		catch (Exception e)
		{
